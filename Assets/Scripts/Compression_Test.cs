...
public class Compression_Test : MonoBehaviour
{
    ...
    void OnGUI()
    {
        GUI.TextArea(new Rect(10, 100, 350, 65), statsText);
        GUI.TextArea(new Rect(10, 165, 350, 65), statsText2);
        lzres = 0; zipres = 0; flzres = 0; lz4res = 0;
        GUI.TextArea(new Rect(10, 250, 350, 70), log, style);
    ...
    private void _FirstDuration()
    {
        ...
        //   UnityEngine.Debug.Log(ppath, gameObject);
    ...
    public void Starting()
    {
        ...
        if (_Assetbundle && decompressedDone && FirstDone) StartCoroutine(Download7ZFile3());
    }
